    ...
    def _prompt_phase_1(self, session) -> Dict[str, Any]:
        return {
            ...
            "question": (
                ...
                "El motor prohíbe el uso de plantillas estándar fijas. Ofrece un catálogo completo de 16 tipos de instrumentos según su función acústica y espectral:\n\n"
    ...
    def _handle_phase_1(self, session: Any, conn: Any, user_input: str) -> Dict[str, Any]:
        ...
        if not roles:
            expected_structure_guide = (
                ...
                "Debes enviar una lista explícita de nombres o roles de instrumentos separados por comas. Puedes combinar libremente cualquiera de los 16 roles acústicos:\n\n"
                "• **Formato requerido:** `[Instrumento 1], [Instrumento 2], [Instrumento 3], ...`\n"
                "• **Ejemplo Amplio:** `Batería, Bombo, Bajo 808, Guitarra Acústica, Piano de Cola, Cuerdas, Coros, Sintetizador Lead, Counter Lead, Ear Candy, Textura Foley, FX (Audio)`\n"
                ...
                " 11. `COUNTER_LEAD`: Arpegios y líneas que responden a la melodía/vocal.\n"
                " 12. `EAR_CANDY`: Plucks, campanas y detalles esporádicos en los bordes estéreo.\n"
                " 13. `TEXTURE_FOLEY`: Ruido orgánico de fondo, vinilo, lluvia a -24 dBFS.\n"
                " 14. `PERCUSSION`: Congas, bongós, shakers, palmas acústicas.\n"
                " 15. `VOCALS`: Pistas vocales solistas o chops vocales procesados.\n"
                " 16. `FX (Audio)` o `FX (MIDI)`: Buses de efectos paralelos o risers/impactos.\n\n"
