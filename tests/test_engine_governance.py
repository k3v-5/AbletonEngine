...
def test_plugin_call_timeout_is_15s():
    """Verifies that plugin and modifying commands enforce safe extended timeouts (20.0s/30.0s)."""
    ...
    mock_sock.settimeout.assert_called_with(20.0)
